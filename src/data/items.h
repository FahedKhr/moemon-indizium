...
// Mega Stones
    ...
    [ITEM_MEGA_GEM] =
    {
        .name = ITEM_NAME("Mega Gem"),
        .pluralName = ITEM_PLURAL_NAME("Mega Gems"),
        .price = 0,
    ...
    [ITEM_MEGA_GEM_X] =
    {
        ...
        .pluralName = ITEM_PLURAL_NAME("Mega Gems X"),
        .price = 0,
        .holdEffect = HOLD_EFFECT_MEGA_STONE,
        .description = COMPOUND_STRING(
            "This stone enables\n"
    ...
    [ITEM_MEGA_GEM_Y] =
    {
        .name = ITEM_NAME("Mega Gem Y"),
        .pluralName = ITEM_PLURAL_NAME("Mega Gems Y"),
        .price = 0,
        .holdEffect = HOLD_EFFECT_MEGA_STONE,
        .description = COMPOUND_STRING(
            "This stone enables\n"
