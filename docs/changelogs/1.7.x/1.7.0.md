...
## 🧬 General 🧬
### Added
* Incorporated @TheXaman's HGSS Style Moédex by @AaghatIsLive in https://github.com/rh-hideout/pokeemerald-expansion/pull/3288
    * Includes Dark Mode
...
* ***Species Simplifier™*** (Parts [1](https://github.com/rh-hideout/pokeemerald-expansion/pull/3544), [2](https://github.com/rh-hideout/pokeemerald-expansion/pull/3546) and [3](https://github.com/rh-hideout/pokeemerald-expansion/pull/3562))
    * **Moved most data from multiple arrays to new fields in `gSpeciesInfo`**
        ...
        * Dex Entries
            * Individual form information is visible in the HGSS Moédex (Vanilla Dex TBD)
            ...
            * Height and Weight are now saved separately per form, so weight in battle is now more accurate.
                * Moédex size page proportions are also separate.
            * Moédex descriptions are now saved as compound strings in `gSpeciesInfo` and differ by form. Shared entries are at the top of `src/data/pokemon/species_info.h`.
                * Missing Moédex texts for forms by @Bassoonian in https://github.com/rh-hideout/pokeemerald-expansion/pull/3708
