...
#define VIVILLON_MISC_INFO(form, color, iconPal)                                            \
    ...
    [SPECIES_LITLEO] =
    {
        ...
        .frontPicFemale = gMonFrontPic_LitleoF,
        .backPicFemale = gMonBackPic_LitleoF,
        .paletteFemale = gMonPalette_LitleoF,
        .shinyPaletteFemale = gMonShinyPalette_LitleoF,
    ...
    [SPECIES_PYROAR] =
    {
        ...
        .paletteFemale = gMonPalette_PyroarF,
        .shinyPaletteFemale = gMonShinyPalette_PyroarF,
    },
